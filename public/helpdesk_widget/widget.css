...
#widget_form .custom_fields input:not([type="checkbox"]):not([type="radio"]),
...
#privacy_policy_fields a {
  font: 12px Arial;
  color: #3699ca;
}

#widget_form .check_box_group {
  display: block;
  max-height: 300px;
  overflow-y: auto;
...
#widget_form .check_box_group label {
  font-weight: normal;
